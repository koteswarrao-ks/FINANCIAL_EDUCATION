...
def profile_agent_fn(child_id: str) -> dict:
    ...
    # Agno tools use entrypoint to call the underlying function
    data = get_user_profile.entrypoint(child_id=child_id)
    ...
    try:
        ...
        retrieved_docs = retrieve_financial_concepts.entrypoint(query=semantic_query, k=5)
...
"""
    ...
    try:
        preferences = get_profile_preferences.entrypoint(child_id=child_id)
